/**
 * MLSpec Propose Experiment Skill Template
 *
 * Template module for MLSpec propose-experiment skill and command.
 */
import type { SkillTemplate, CommandTemplate } from '../types.js';

export function getMlspecProposeExperimentSkillTemplate(): SkillTemplate {
  return {
    ...
    instructions: `Create a new MLSpec experiment with a filled hypothesis.
...
export function getMlspecProposeExperimentCommandTemplate(): CommandTemplate {
  return {
    name: 'MLSpec: Propose Experiment',
    description: 'Create a new MLSpec experiment with a filled hypothesis. Use when the user wants to formalize an experiment idea with clear hypothesis, success criteria, and evidence plan.',
    category: 'Workflow',
    tags: ['workflow', 'mlspec', 'ml', 'experiment', 'propose'],
    content: `Create a new MLSpec experiment with a filled hypothesis.
