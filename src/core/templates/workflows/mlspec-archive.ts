/**
 * MLSpec Archive Skill Template
 *
 * Template module for MLSpec archive skill and command.
 */
import type { SkillTemplate, CommandTemplate } from '../types.js';

export function getMlspecArchiveSkillTemplate(): SkillTemplate {
  return {
    name: 'mlspec-archive',
    ...
    instructions: `Archive a decided MLSpec experiment.
...
export function getMlspecArchiveCommandTemplate(): CommandTemplate {
  return {
    name: 'MLSpec: Archive',
    description: 'Archive a decided MLSpec experiment. Use when an experiment has been decided and should be moved to the archive.',
    category: 'Workflow',
    tags: ['workflow', 'mlspec', 'ml', 'experiment', 'archive'],
    content: `Archive a decided MLSpec experiment.
