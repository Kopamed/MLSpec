/**
 * MLSpec Promote Skill Template
 *
 * Template module for MLSpec promote skill and command.
 */
import type { SkillTemplate, CommandTemplate } from '../types.js';

export function getMlspecPromoteSkillTemplate(): SkillTemplate {
  return {
    name: 'mlspec-promote',
    ...
    instructions: `Promote an MLSpec experiment to a candidate version.
...
export function getMlspecPromoteCommandTemplate(): CommandTemplate {
  return {
    name: 'MLSpec: Promote',
    description: 'Promote an MLSpec experiment to a candidate version. Use when an experiment has a promote decision and should be incorporated into a candidate recipe.',
    category: 'Workflow',
    tags: ['workflow', 'mlspec', 'ml', 'experiment', 'promote'],
    content: `Promote an MLSpec experiment to a candidate version.
