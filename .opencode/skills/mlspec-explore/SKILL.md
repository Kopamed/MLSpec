...
Explore ML experiment ideas, inspect recipes/experiments/evidence, reason about failure modes, and propose possible experiments. Use when you want to understand the current state of the ML workspace and identify promising directions.
