# fixture-003-smoke-promoted-as-validation (Modified)
...
**Reason:** Replaced by structured fixture.yaml validation. Expected values now come from fixture.yaml not expected.txt.
**Migration:** Use fixture.yaml expected.verdict and expected.failed_checks
